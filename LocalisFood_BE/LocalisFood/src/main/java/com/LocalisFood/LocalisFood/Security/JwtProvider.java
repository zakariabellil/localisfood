...
import com.LocalisFood.LocalisFood.Service.UserDetailsServiceImpl;
...
public class JwtProvider {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new SpringLocalisFoodException("Expired or invalid JWT token", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
